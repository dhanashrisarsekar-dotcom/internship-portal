...
import { hyderabadInternships } from "../Data/HyderabadData";

const HyderabadInternships = () => {
  return (
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-blue-50 border border-blue-100 rounded-xl p-8 text-center mt-10">
          <h2 className="text-xl font-bold mb-4 text-gray-800">
            Register now to find personalized matches in Hyderabad
          </h2>
          <div className="flex justify-center gap-4 flex-wrap">
            <button className="bg-white border border-gray-200 px-6 py-2 rounded-lg font-bold shadow-sm hover:bg-gray-50">
...
export default HyderabadInternships;